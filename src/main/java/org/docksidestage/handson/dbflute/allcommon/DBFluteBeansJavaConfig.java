 ...
 */
@Configuration
@ComponentScan(value="org.docksidestage.handson.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    protected DBFluteInitializer newDBFluteInitializer(DataSource dataSource) {
        return new org.docksidestage.handson.dbflute.allcommon.DBFluteInitializer(dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new org.docksidestage.handson.dbflute.allcommon.ImplementedInvokerAssistant();
    }
